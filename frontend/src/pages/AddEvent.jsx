...
import { X, CheckCircle, Calendar, Clock, User, Plus, ChevronRight } from "lucide-react";
...
const EventPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-200">
      ...
      <section id="event-form-hero" className="animate-on-scroll relative pt-24 pb-20 px-4 overflow-hidden">
      ...
      {/* Form Section */}
      <section id="event-form" className="animate-on-scroll relative px-4 pb-20">
        <div className={`max-w-3xl mx-auto relative z-10 ${animatedSections['event-form'] ? 'animate-fade-in' : 'opacity-0'}`}>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gray-900 border border-gray-800 rounded-xl p-8 shadow-xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Title Input */}
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300 flex items-center">
                    <span className="bg-gradient-to-r from-blue-800 to-blue-900 p-2 rounded-lg mr-3">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-gray-200 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-blue-500 focus:ring focus:ring-blue-500/20 focus:outline-none transition-all duration-200"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300 flex items-center">
                    <span className="bg-gradient-to-r from-purple-800 to-purple-900 p-2 rounded-lg mr-3">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 text-gray-200 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-purple-500 focus:ring focus:ring-purple-500/20 focus:outline-none transition-all duration-200"
                    required
                    disabled={success}
                  />
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300 flex items-center">
                    <span className="bg-gradient-to-r from-green-800 to-green-900 p-2 rounded-lg mr-3">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 text-gray-200 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-green-500 focus:ring focus:ring-green-500/20 focus:outline-none transition-all duration-200"
                    required
                    disabled={success}
                  />
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300 flex items-center">
                    <span className="bg-gradient-to-r from-yellow-800 to-yellow-900 p-2 rounded-lg mr-3">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 text-gray-200 bg-gray-800/50 rounded-lg border border-gray-700 focus:border-yellow-500 focus:ring focus:ring-yellow-500/20 focus:outline-none transition-all duration-200"
